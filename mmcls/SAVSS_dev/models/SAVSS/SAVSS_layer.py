...
try:
    # Older mamba-ssm (v1.x / early v2.x)
    from mamba_ssm.ops.triton.layernorm import RMSNorm, layer_norm_fn, rms_norm_fn
except ImportError:
    try:
        # Newer mamba-ssm (v2.2.x+)
        from mamba_ssm.ops.triton.layer_norm import RMSNorm, layer_norm_fn, rms_norm_fn
    except ImportError:
        # Some builds expose only the gated variant
        from mamba_ssm.ops.triton.layernorm_gated import RMSNorm  # type: ignore
        layer_norm_fn = rms_norm_fn = None
